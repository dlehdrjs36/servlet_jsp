...
public class BDao {
	...
	public ArrayList<BDto> list() {
		...
		try {
			...
			String query = "select bId, bName, bTitle, bContent, bDate, bHit, bGroup, bStep, bIndent from mvc_board order by bGroup desc, bStep asc"; // bStep = 댓글은 먼저쓴거부터 보여달라 , bGroup = 글은 최신글부터 보여줘라
			preparedStatement = connection.prepareStatement(query);
