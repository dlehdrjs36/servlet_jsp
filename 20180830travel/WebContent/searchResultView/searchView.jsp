...
<!--  항공편 조회폼 -->
<form action="#" style="max-width:1000px;margin:auto" onsubmit="return check()">
  ...
  <div class="input-container">
    ...
    <input class="input-field testDatepicker" type="text" placeholder="출발날짜" name="fromdate" id="fromdate" >
    <i class="fa fa-envelope icon"></i>
    <input class="input-field testDatepicker" type="text" placeholder="도착날짜" name="todate" id="todate">
  </div>
  <div class="input-container">	
  	<h2>성인 </h2>
